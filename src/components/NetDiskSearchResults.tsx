                                ...
                                <div className='space-y-2'>
                                  ...
                                  <div className='flex justify-start'>
                                    <button
                                      ...
                                      className='inline-flex items-center space-x-1 px-2 py-1 bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/20 dark:hover:bg-blue-800/30 text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-200 text-xs font-medium rounded-md border border-blue-200 dark:border-blue-600 transition-all duration-200 ease-in-out'
                                    >
                                      <span>
