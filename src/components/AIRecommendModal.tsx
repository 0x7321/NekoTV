  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-4xl h-[80vh] mx-4 bg-white dark:bg-gray-900 rounded-lg shadow-2xl flex flex-col overflow-hidden">
        {/* 头部 */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-500 to-emerald-500">
        ...
        >
          {messages.length <= 1 && messages.every(msg => msg.role === 'assistant' && msg.content.includes('AI智能助手')) && (
            <div className="text-center py-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-400 to-emerald-500 rounded-full mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                {AI_RECOMMEND_PRESETS.map((preset, index) => (
                  <button
                    ...
                    className="p-3 text-left bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-400 hover:shadow-md transition-all group"
                    disabled={isLoading}
                  >
                    <div className="font-medium text-gray-900 dark:text-gray-100 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">
                      {preset.title}
                    </div>
                  </button>
                ))}
                ...
                <div className="mt-3 space-y-2 max-w-[80%]">
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-2 flex items-center justify-between">
                    <div className="flex items-center">
                      <span className="bg-blue-100 dark:bg-blue-900 text-blue-500 dark:text-blue-400 px-2 py-1 rounded-full text-xs font-medium mr-2">
                        🎬 点击搜索
                      </span>
                      推荐影片卡片
                    </div>
                  ...
                  {message.recommendations.map((movie, index) => (
                    <div
                      ...
                      className="p-3 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:shadow-md hover:border-blue-200 dark:hover:border-blue-500 hover:scale-[1.02] transition-all group"
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-medium text-gray-900 dark:text-white text-sm flex items-center">
                            ...
                            <span className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity text-blue-400 text-xs">
                              🔍 搜索
                            </span>
                          </h4>
                          {movie.genre && (
                            <p className="text-xs text-blue-500 dark:text-blue-400 mt-1">{movie.genre}</p>
                          )}
          ...
          <form onSubmit={handleSubmit} className="flex space-x-3">
            <div className="flex-1">
              <textarea
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 resize-none"
                rows={2}
                disabled={isLoading}
              />
            </div>
