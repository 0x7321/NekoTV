    ...
    const getRatingBadgeStyle = useCallback((rateStr: string) => {
      ...
      if (rateNum >= 8.5) {
        ...
        return {
          ...
          textColor: 'text-white',
          glowClass: 'group-hover:shadow-blue-400/50',
        };
      } else if (rateNum >= 6.0) {
        // 中分：绿色
        return {
          ...
          ringColor: 'ring-2 ring-green-300/40',
          shadowColor: 'shadow-md',
          textColor: 'text-white',
          glowClass: 'group-hover:shadow-green-400/50',
        };
      } else {
        // 低分：灰色
        return {
        ...
        >
          ...
          >
            ...
            {config.showYear &&
              ...
              actualYear.trim() !== '' && (
                <div
                  className={`absolute left-2 bg-gradient-to-br from-emerald-400/90 via-emerald-400/90 to-teal-400/90 backdrop-blur-md text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg ring-2 ring-white/30 transition-all duration-300 ease-out group-hover:scale-105 group-hover:shadow-emerald-400/50 group-hover:ring-emerald-200/50 ${
                    actualEpisodes && actualEpisodes > 1
                      ? 'top-[48px]'
                      : 'top-2'
                  }`}
          ...
          >
            ...
            {config.showSourceName && source_name && (
              ...
              >
                ...
                >
                  {/* 背景渐变效果 */}
                  <span className='absolute inset-0 bg-gradient-to-r from-transparent via-green-50/0 to-transparent dark:via-green-400/0 group-hover:via-green-50/80 dark:group-hover:via-green-400/20 transition-all duration-300'></span>
