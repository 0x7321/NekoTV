...
function PlayPageClient() {
        ...
        <div className='flex items-center justify-center min-h-screen bg-transparent'>
          <div className='text-center max-w-md mx-auto px-6'>
            ...
            <div className='relative mb-8'>
              <div className='relative mx-auto w-24 h-24 bg-gradient-to-r from-green-400 to-emerald-500 rounded-2xl shadow-2xl flex items-center justify-center transform hover:scale-105 transition-transform duration-300'>
                ...
                {/* 旋转光环 */}
                <div className='absolute -inset-2 bg-gradient-to-r from-green-400 to-emerald-500 rounded-2xl opacity-20 animate-spin'></div>
              </div>
          ...
          <div className='text-center max-w-md mx-auto px-6'>
            ...
            <div className='space-y-3'>
              <button
                ...
                className='w-full px-6 py-3 bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-xl font-medium hover:from-green-500 hover:to-emerald-600 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl'
              >
  ...
  return (
    <PageLayout activePath='/play'>
              ...
              <div className='mb-4 flex-shrink-0'>
                <div className='flex flex-col md:flex-row md:items-center gap-3'>
                  ...
                  <div className='flex items-center justify-center md:justify-start gap-2 flex-wrap'>
                    ...
                    >
                      <div className='absolute inset-0 bg-gradient-to-r from-red-400 to-orange-400 rounded-full opacity-0 group-hover:opacity-20 blur-lg transition-opacity duration-300'></div>
                    ...
                    >
                      ...
                      <div className='relative flex items-center gap-1.5 bg-gradient-to-r from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white px-3 py-1.5 rounded-full text-sm font-medium shadow-lg hover:shadow-xl transition-all duration-300'>
                        📁
                        {netdiskLoading ? (
                          ...
                          parseFloat(bangumiDetails.rating.score) > 0 && (
                            <div className='flex items-center gap-2'>
                              ...
                              <div className='flex items-center group'>
                                <span className='relative text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-teal-600 to-teal-500 dark:from-teal-400 dark:via-teal-400 dark:to-teal-400 font-bold text-lg transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_2px_8px_rgba(236,72,153,0.5)]'>
                                  {bangumiDetails.rating.score}
                                </span>
                                    ...
                                    <svg
                                      ...
                                      className={`w-4 h-4 transition-all duration-300 ${
                                        ...
                                        Math.floor(
                                          ...
                                          ? 'text-teal-400 drop-shadow-[0_0_4px_rgba(236,72,153,0.5)] group-hover:scale-110'
                          ...
                          {bangumiDetails.tags &&
                            bangumiDetails.tags
                              ...
                              .map((tag: any, index: number) => (
                                <span
                                  key={index}
                                  className='relative group bg-gradient-to-r from-blue-400/90 to-emerald-400/90 dark:from-blue-500/90 dark:to-emerald-500/90 text-white px-3 py-1 rounded-full text-xs font-medium shadow-md hover:shadow-lg hover:shadow-blue-400/30 transition-all duration-300 hover:scale-105'
                                >
                                  <span className='absolute inset-0 bg-gradient-to-r from-blue-400 to-emerald-400 rounded-full opacity-0 group-hover:opacity-20 blur transition-opacity duration-300'></span>
                  ...
                  <div className='space-y-2 text-sm'>
                    ...
                    {detail?.episodes && detail.episodes.length > 0 && (
                      <div className='flex flex-wrap gap-2'>
                        <span className='relative group bg-gradient-to-r from-blue-400/90 to-emerald-400/90 dark:from-blue-500/90 dark:to-emerald-500/90 text-white px-3 py-1 rounded-full text-xs font-medium shadow-md hover:shadow-lg hover:shadow-blue-400/30 transition-all duration-300 hover:scale-105'>
                          <span className='absolute inset-0 bg-gradient-to-r from-blue-400 to-emerald-400 rounded-full opacity-0 group-hover:opacity-20 blur transition-opacity duration-300'></span>
                          <span className='relative'>
                        ...
                        <span className='relative group bg-gradient-to-r from-emerald-400/90 to-teal-400/90 dark:from-emerald-500/90 dark:to-teal-500/90 text-white px-3 py-1 rounded-full text-xs font-medium shadow-md hover:shadow-lg hover:shadow-emerald-400/30 transition-all duration-300 hover:scale-105'>
                    ...
                    <h3 className='text-xl font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-2'>
                      ...
                      {netdiskLoading && (
                        <span className='inline-block align-middle'>
                          <span className='inline-block h-4 w-4 border-2 border-gray-300 border-t-blue-400 rounded-full animate-spin'></span>
                        </span>
                      )}
                      {netdiskTotal > 0 && (
                        ...
                        >
                          <div
                            className={`absolute inset-0 ${
                              bangumiDetails ? 'bg-teal-400' : 'bg-green-400'
      ...
      >
        {/* 渐变背景 */}
        <div className='absolute inset-0 bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 group-hover:from-green-500 group-hover:via-emerald-500 group-hover:to-teal-500 transition-all duration-300'></div>
