  ...
  return (
    <PageLayout>
      <div className='px-2 sm:px-10 py-4 sm:py-8 overflow-visible'>
        {/* 欢迎横幅 - 在所有 tab 显示 */}
        <div className='mb-6 mt-0 md:mt-12 relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 p-[2px] shadow-lg animate-[slideDown_0.5s_ease-out]'>
          <div className='relative bg-white dark:bg-gray-900 rounded-2xl p-5 sm:p-6'>
            ...
            <div className='absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-teal-400/10 to-emerald-400/10 rounded-full blur-2xl'></div>
              ...
              <div className='flex items-start justify-between gap-4'>
                <div className='flex-1 min-w-0'>
                  <h2 className='text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-1.5 flex items-center gap-2 flex-wrap'>
                    ...
                    {username && (
                      <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-500 dark:from-green-400 dark:to-emerald-400'>
                        {username}
                      </span>
                    )}
        ...
        <div className='mb-8 flex flex-col sm:flex-row items-center justify-center gap-4'>
          ...
          {aiEnabled && (
            <button
              ...
              className='relative flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-full font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-xl group overflow-hidden'
              title='AI影视推荐'
            >
              {/* 脉冲光环 */}
              <div className='absolute inset-0 rounded-full bg-gradient-to-r from-green-400 to-emerald-400 opacity-0 group-hover:opacity-100 animate-ping'></div>

              {/* 闪烁背景 */}
              <div className='absolute inset-0 rounded-full bg-gradient-to-r from-green-400 to-emerald-400 opacity-20 animate-pulse'></div>
                ...
                {favoriteItems.length === 0 && (
                  <div className='col-span-full flex flex-col items-center justify-center py-16 px-4'>
                    ...
                    <div className='mb-6 relative'>
                      <div className='absolute inset-0 bg-gradient-to-r from-teal-300 to-emerald-200 dark:from-teal-500 dark:to-emerald-500 opacity-20 blur-3xl rounded-full animate-pulse'></div>
                      <svg
      ...
      {announcement && showAnnouncement && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => handleCloseAnnouncement(announcement)}
              className='w-full rounded-lg bg-gradient-to-r from-green-500 to-green-600 px-4 py-3 text-white font-medium shadow-md hover:shadow-lg hover:from-green-600 hover:to-green-800 dark:from-green-500 dark:to-green-600 dark:hover:from-green-600 dark:hover:to-green-800 transition-all duration-300 transform hover:-translate-y-0.5'
            >
              我知道了
            </button>
          </div>
