              ...
              <div className='inline-flex items-center bg-gradient-to-r from-gray-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-750 dark:to-gray-800 rounded-xl p-1.5 space-x-2 shadow-lg border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm'>
                <button
                  ...
                  className={`px-5 py-2.5 text-sm font-semibold rounded-lg transition-all duration-300 relative overflow-hidden ${
                    searchType === 'video'
                      ? 'bg-gradient-to-br from-green-400 via-green-400 to-emerald-500 text-white shadow-lg scale-105'
                ...
                <button
                  ...
                  className={`px-5 py-2.5 text-sm font-semibold rounded-lg transition-all duration-300 relative overflow-hidden ${
                    searchType === 'netdisk'
                      ? 'bg-gradient-to-br from-blue-400 to-blue-500 text-white shadow-lg scale-105'
                      : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/50'
                  }`}
                >
                  💾 网盘资源
                ...
                <button
                  ...
                  className={`px-5 py-2.5 text-sm font-semibold rounded-lg transition-all duration-300 relative overflow-hidden ${
                    searchType === 'youtube'
                      ? 'bg-gradient-to-br from-red-400 to-red-500 text-white shadow-lg scale-105'
                      : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/50'
                  }`}
                >
                  📺 YouTube
                ...
                <button
                  ...
                  className={`px-5 py-2.5 text-sm font-semibold rounded-lg transition-all duration-300 relative overflow-hidden ${
                    searchType === 'tmdb-actor'
                      ? 'bg-gradient-to-br from-emerald-400 via-emerald-400 to-teal-500 text-white scale-105'
                      : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/50'
                  }`}
                >
                  🎬 TMDB演员
                ...
                <>
                  <div className='mb-4'>
                    <h2 className='text-xl font-bold text-gray-800 dark:text-gray-200'>
                      ...
                      {tmdbActorLoading && (
                        <span className='ml-2 inline-block align-middle'>
                          <span className='inline-block h-3 w-3 border-2 border-gray-300 border-t-blue-400 rounded-full animate-spin'></span>
                        </span>
                      )}
                    </h2>
                  ...
                  <div className='mb-8 space-y-4'>
                    ...
                    <div className='flex items-center justify-end gap-6'>
                      ...
                      <label className='flex items-center gap-3 cursor-pointer select-none shrink-0 group'>
                        <span className='text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors'>
                          ⚡ 虚拟滑动
                        </span>
                        <div className='relative'>
                          ...
                          />
                          <div className='w-11 h-6 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full peer-checked:from-blue-400 peer-checked:to-emerald-400 transition-all duration-300 dark:from-gray-600 dark:to-gray-700 dark:peer-checked:from-blue-400 dark:peer-checked:to-emerald-500 shadow-inner'></div>
                          <div className='absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-all duration-300 peer-checked:translate-x-5 shadow-lg peer-checked:shadow-blue-200 dark:peer-checked:shadow-blue-400/50 peer-checked:scale-105'></div>
                          {/* 开关内图标 */}
                      ...
                      {/* 聚合开关 */}
                      <label className='flex items-center gap-3 cursor-pointer select-none shrink-0 group'>
                        <span className='text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors'>
                          🔄 聚合
                        </span>
                        <div className='relative'>
                          <input
                          ...
                          />
                          <div className='w-11 h-6 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full peer-checked:from-emerald-400 peer-checked:to-green-400 transition-all duration-300 dark:from-gray-600 dark:to-gray-700 dark:peer-checked:from-emerald-400 dark:peer-checked:to-green-500 shadow-inner'></div>
                          <div className='absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-all duration-300 peer-checked:translate-x-5 shadow-lg peer-checked:shadow-emerald-200 dark:peer-checked:shadow-emerald-400/50 peer-checked:scale-105'></div>
                          {/* 开关内图标 */}
                          <div className='absolute top-1.5 left-1.5 w-3 h-3 flex items-center justify-center pointer-events-none transition-all duration-300 peer-checked:translate-x-5'>
                            <span className='text-[10px] peer-checked:text-white text-gray-500'>
                              {viewMode === 'agg' ? '🔗' : '○'}
