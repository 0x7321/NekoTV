...
const USER_LEVELS = [
  ...
  },
  {
    ...
    maxLogins: 9999,
    description: '影视殿堂的至尊',
    gradient: 'from-teal-400 via-teal-450 to-teal-500',
  },
  {
    level: 8,
    name: '永恒之光',
    ...
    gradient: 'from-emerald-400 via-emerald-400 to-teal-400',
  },
];
        ...
        <div className='max-w-7xl mx-auto px-4 py-8'>
          ...
          <div className='flex justify-between items-end mb-8'>
            ...
            <button
              ...
              disabled={loading}
              className='px-4 py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-blue-400 text-white text-sm rounded-lg transition-colors flex items-center space-x-2 mb-0.5'
            >
              <svg
                ...
                <div className='p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700'>
                  ...
                  <div className='space-y-3'>
                    {statsData.topSources.map((source, index) => (
                      ...
                      >
                        <div className='flex items-center space-x-3'>
                          <span className='w-6 h-6 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full flex items-center justify-center text-xs font-bold'>
                            {index + 1}
                          </span>
            ...
            <>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 mb-8'>
                ...
                >
                  ...
                  {(watchingUpdates?.continueWatchingCount || 0) > 0 && (
                    <div className='text-xs text-blue-400 dark:text-blue-400 mt-1'>
                      有剧集待续看！
                    </div>
                  )}
                </div>
              ...
              {(upcomingInitialized || upcomingLoading) && (
                <div className='mb-8'>
                  <div className='bg-gradient-to-r from-slate-700 to-slate-800 dark:from-slate-800 dark:to-slate-900 rounded-lg p-6 text-white shadow-lg'>
                        ...
                        <div className='flex flex-col gap-6'>
                          ...
                          {upcomingReleases.filter(
                            ...
                            <div className='w-full'>
                              <div className='text-sm font-medium text-slate-200 mb-3 flex items-center gap-2 border-b border-white/20 pb-2'>
                                🎬 电影
                              </div>
                        ...
                        {watchingUpdates.updatedSeries
                          ...
                          .map((series, index) => (
                            ...
                            >
                              ...
                              {/* 新集数徽章 */}
                              <div className='absolute -top-2 -right-2 bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs px-2 py-1 rounded-full shadow-lg animate-bounce z-[502]'>
                        ...
                        {watchingUpdates.updatedSeries
                          ...
                          .map((series, index) => (
                            ...
                            >
                              ...
                              {/* 继续观看徽章 */}
                              <div className='absolute -top-2 -right-2 bg-gradient-to-r from-blue-400 to-cyan-500 text-white text-xs px-2 py-1 rounded-full shadow-lg animate-pulse z-[502]'>
                                继续看
                              </div>
                            </div>
                          ))}
    ...
    return (
      <PageLayout activePath='/play-stats'>
        <div className='max-w-6xl mx-auto px-4 py-8'>
          ...
          {(upcomingInitialized || upcomingLoading) && (
            <div className='mb-8'>
              <div className='bg-gradient-to-r from-emerald-400 to-teal-400 rounded-lg p-6 text-white shadow-lg'>
                <div className='flex items-center justify-between mb-4'>
                  <div>
                    <h3 className='text-lg font-bold flex items-center gap-2'>
                      📅 即将上映
                    ...
                    {watchingUpdates.updatedSeries
                      ...
                      .map((series, index) => (
                        ...
                        >
                          ...
                          {/* 继续观看标识 */}
                          <div className='absolute -top-2 -right-2 bg-gradient-to-r from-blue-400 to-cyan-500 text-white text-xs px-2 py-1 rounded-full shadow-lg z-[502]'>
                            继续观看
                          </div>
                        </div>
                      ))}
